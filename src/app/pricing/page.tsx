...
const plans = [
  ...
  { name: "Selector", accent: "var(--orange-soft)", price: "Live in Clerk", club: "Own 1 · join unlimited", features: ["Everything in Listener", "Full custom schedules", "Themes, backups, and admin tools"] },
